...
numpy* np,matrixStr* feature,matrixStr* label,matrixStr* weight,float learnRate,u32 times);			//训练

matrixStr* TrainMinist(numpy* np,matrixStr* feature,matrixStr* label,matrixStr* weight,float learnRate,u32 times);//训练MINIST数据集
